                                            ...
                                            <form action="${pageContext.request.contextPath}/reservation" method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="guest_name"
                                                            name="guest_name" placeholder="Full name" required>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <select class="form-select" id="room_type" name="room_type"
                                                            required onchange="updateRateDisplay()">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="check_in"
                                                            name="check_in" required onchange="calculateBill()">
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="check_out"
                                                            name="check_out" required onchange="calculateBill()">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <div class="form-control bg-light border-primary"
                                                            id="bill_display"
