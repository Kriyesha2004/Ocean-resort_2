                                ...
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex gap-2">
                                            <form action="${pageContext.request.contextPath}/view/reservations-list"
                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                <% try { Connection conn=DBConnection.getConnection(); /*
                                                    Auto-cancellation logic */ String
                                                    updateSql="UPDATE reservations SET status = 'Cancelled' WHERE status = 'Pending' AND check_out < CURDATE()"
                                                    ; PreparedStatement updatePst=conn.prepareStatement(updateSql);
                                                    updatePst.executeUpdate(); updatePst.close(); String
                                                    ...
                                                    roomNumber.equals("null")) roomNumber="-" ; String
