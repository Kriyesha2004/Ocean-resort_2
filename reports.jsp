                                ...
                                <tbody>
                                    <%
                                        try {
                                            ...
                                            String query = "SELECT DATE(check_in) as date, " +
                                                         ...
                                                         "ORDER BY DATE(check_in) DESC LIMIT 30";
                                            PreparedStatement pst = conn.prepareStatement(query);
                                            ResultSet rs = pst.executeQuery();
                                            
                                            while (rs.next()) {
                                                int single = rs.getInt("single_rooms");
                                                int double_r = rs.getInt("double_rooms");
                                                int luxury = rs.getInt("luxury_rooms");
                                                int total = single + double_r + luxury;
                                    %>
                                    <tr>
                                        <td><strong><%= rs.getString("date") %></strong></td>
                                        <td><%= single %></td>
                                        <td><%= double_r %></td>
                                        <td><%= luxury %></td>
                                        <td><%= total %></td>
                                        <td>
                                            <div class="progress" style="height: 20px;">
                                                <div class="progress-bar" role="progressbar" style="width: <%= (total * 100 / 30) %>%">
                                                    <%= (total * 100 / 30) %>%
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <%
                                            ...
                                            out.println("<tr><td colspan='6' class='text-danger text-center'>Error loading report: " + e.getMessage() + "</td></tr>");
                                        }
                                    %>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <%
                                        try {
                                            ...
                                            while (rs.next()) {
                                                ...
                                                double avg = rs.getDouble("avg_bill");
                                    %>
                                    <tr>
                                        <td><strong><%= rs.getString("month") %></strong></td>
                                    ...
                                    <%
                                            ...
                                            out.println("<tr><td colspan='4' class='text-danger text-center'>Error loading revenue data: " + e.getMessage() + "</td></tr>");
                                        }
                                    %>
                                </tbody>
                            </table>
